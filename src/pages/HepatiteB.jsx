    ...
    return (
        <div>
            ...
            <div id="page-vaccines">
                <main>
                    <Fade bottom>
                        <h2 className="titulo">Vacina da hepatite B</h2>
                        ...
                        <h2 className="titulo">Esquema de vacinação</h2>
                        ...
                        <h3>Onde pode ser encontrada:</h3>
